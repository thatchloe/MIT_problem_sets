...
class SimpleVirus(object):
    ...
    def reproduce(self, popDensity):
        ...
        repro_prob = random.random()
        if repro_prob <= self.maxBirthProb*(1-self.popDensity) :
...
def simulationWithoutDrug(numViruses, maxPop, maxBirthProb, clearProb,
    ...
    for i in range(numTrials):
        ...
        sum_pop = sum_pop + population   
    avg_pop = sum_pop/numTrials
...
class ResistantVirus(SimpleVirus):
    ...
    def isResistantTo(self, drug):
        ...
        if drug in self.resistances.keys():
            return True if self.resistances[drug] == True else False
    ...
    def reproduce(self, popDensity, activeDrugs):
        ...
        repro_prob = random.random()
        if repro_prob <= self.maxBirthProb * (1 - popDensity):
