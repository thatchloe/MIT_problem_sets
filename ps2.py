...
class StandardRobot(Robot):
    ...
    def updatePositionAndClean(self):
        ...
        next_position = self.getRobotPosition().getNewPosition(angle, self.speed)
...
runSimulation(4, 2.0, 20, 20, 0.75, 3, StandardRobot)
...
class RandomWalkRobot(Robot):
    ...
    def updatePositionAndClean(self):
        ...
        #raise NotImplementedError
#print(runSimulation(1, 1.0, 10, 10, 0.75, 3, RandomWalkRobot))
